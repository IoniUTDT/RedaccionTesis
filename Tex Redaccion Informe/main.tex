...
\subsection{La creación de los estímulos}
    
    Desde un principio el objetivo fue testear la capacidad de los usuarios de distinguir categorías y aspectos geométricos de los estímulos por lo tanto pensamos en diferenciar si un ángulo era recto o no recto, si dos segmentos eran paralelos o no y si un cuadrilátero era cuadrado o no cuadrado. Pensando en esta última categoría como una combinación de las dos anteriores que reflejaría en algun punto efectos de transferencia. 
