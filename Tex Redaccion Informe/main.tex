...
%\textsc{Instituto de Astronomía y Física del Espacio (CONICET-UBA)}

% Titulo

\rule[1em]{40em}{0.5pt}
\begin{center}
%\huge Desarrollo, modelado y construcción del control térmico de un radiómetro de microondas en banda L\\
%\huge Diseño y desarrollo del control térmico de un radiómetro de microondas en banda L\\
...
\subsection{Código de la última implementación del StairCase} \label{anexo:staircase}
 ...
 \begin{lstlisting}[caption=Definición de la clase donde se almacena la información del StairCase]
